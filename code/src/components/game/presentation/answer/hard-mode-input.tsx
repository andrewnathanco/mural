      ...
      {game.status == GameStatus.started ? (
        <div class="relative">
          ...
          <input
            ...
            class="block w-full px-4 py-2 ps-10 text-sm text-river-bed-700 bg-desert-sand-100 border-2 border-river-bed-700 placeholder:text-river-bed-700 rounded-md focus:ring-river-bed-700 focus:border-river-bed-700"
            required
          />
        </div>
      ) : (
